            ...
            <div className="m-3 z-2 relative w-full max-w-md bg-white max-md:mt-20 rounded-xl shadow-md p-8">
                ...
                {/* <button onClick={handleGoogleLogin} className="gsi-material-button">
                    ...
                    <div className="gsi-material-button-content-wrapper">
                		...
                		<button onClick={() => window.open(`${import.meta.env.VITE_BASE_URL}/auth/admin/google`, "_self")} className="w-full border border-gray-200 flex justify-center gap-3 shadow-lg cursor-pointer hover:shadow-md hover:bg-gray-100 py-2 rounded-md" variant="outline">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 48 48"
